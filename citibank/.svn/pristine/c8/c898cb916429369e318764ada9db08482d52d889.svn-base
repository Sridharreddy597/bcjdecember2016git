...
<div class="container">
  ...
  <div class="panel-group" id="accordion">
    ...
    <div class="panel panel-default">
      ...
      <input type="text" class="form-control" name="address.addressLine1" placeholder="addressLine1" required>
    </span>
     <span class="form-group">
     
      <input type="text" class="form-control" name="address.addressLine2" placeholder="addressLine2" required>
    </span>
     <span class="form-group">
    ...
    <span class="form-group">
      ...
      <input type="text" class="form-control" name="address.state" placeholder="State" required>
    </span>
    <span class="form-group">
     
      <input type="text" class="form-control" name="address.zip" placeholder="Zip" required>
    </span>
   ...
   <div class="panel panel-default">
      ...
      <input type="text" class="form-control" name="mobile" placeholder="Primary Number" required style="width: 159px; ">
    </div>
  ...
  <div class="panel panel-default">
      ...
      <input type="email" class="form-control" name="email" placeholder="Email " required style="width: 232px; ">
    </div>
        </div>
  ...
  <div class="panel panel-default">
      ...
      <input type="date" class="form-control" name="dateOfBirth" value="2017-04-11"  placeholder="Date-of-Birth " required style="width: 158px; ">
    </div>
  ...
  <div class="panel panel-default">
      ...
      <input type="password" class="form-control" name="ssn" placeholder="SSN " required style="width: 203px; ">
    </div>
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse7">Annual Income</a>
        </h4>
      </div>
     ...
     <span class="form-group">
      ...
      <input type="text" class="form-control" name="houseMortage" placeholder="House Mortage" >
    </span>
