  ...
  <div class="panel-group" id="accordion">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Activate card  & create account</a>
        </h4>
      </div>
    ...
    <span class="form-group">
      ...
      <input type="text" class="form-control" name="creditcard.cardNumber" placeholder="cardNumber" required>
    </span>
