...
<div>
	...
	<form commandName="cust" action="getfrm" method="GET" id="submitGetForm">
	...
	<script>
		...
		type : 'GET',
		url : '/restclient/getfrm/'+id1,
		success : function(customer) {
		
	  $("#result1").append('<li>     id : '+ customer.id+ ',   firstname : '+ customer.firstName+ ', lastName : '+ customer.lastName+ ', application : '+ customer.application+ '</li>');
