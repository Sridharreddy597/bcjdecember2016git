...
public class CustomerController {
	...
	@RequestMapping("/jmsfrm")
	public String displayJMSForm() {
		return "jmsfrm";
	}
	...
	@RequestMapping(value = "/jmsfrmsubmit", method = RequestMethod.POST)
	public @ResponseBody String submittedcustomerData(@RequestBody String message, HttpServletRequest request) {
		System.out.println(message);		
		//Customer c = custService.saveCustomer(message);
		return message;
	}
