...
public class QuickSortDemo {
	public static void main(String args[]) {
		...
		QuickSort algorithm = new QuickSort(); // sorting integer array using
												// quicksort algorithm
 ...
 * merge it to create sorted output. * * @author Javin Paul
 */
class QuickSort {
	...
	private void quickSort(int low, int high) {
		...
		while (i <= j) {
			/** * As shown in above image, In each iteration, we
			 will identify a * number from left side which is
			 greater then the pivot value, and * a number from
